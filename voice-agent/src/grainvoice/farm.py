...
GRAIN_KEYTERMS = [
    # Налогообложение. Спрашивается в каждом звонке, а без подсказки
    # «без НДС» слышится как «бизнес» — проверено на живом разговоре.
    "НДС", "без НДС", "с НДС", "упрощёнка", "плательщик НДС",
    # Культуры
    "пшеница", "ячмень", "кукуруза", "подсолнечник", "рапс", "соя",
    "озимая", "яровая",
    # Качество
    "протеин", "клейковина", "натура", "влажность", "сорная примесь",
    "класс", "третий класс", "четвёртый класс",
    # Объёмы и логистика
    "тонна", "тонн", "гектар", "урожайность",
    "элеватор", "самовывоз", "перевалка", "предоплата", "КФХ",
]
