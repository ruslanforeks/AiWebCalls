...
class Settings(BaseSettings):
    ...
    # Представляться ли автоматическим помощником. Выключено — так выбрано
    # заказчиком. Включается одной переменной, если возникнут требования
    # юротдела клиента; переписывать код для этого не нужно.
